...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/05/13 13:56:00 by tzara             #+#    #+#             */
/*   Updated: 2026/05/13 14:05:51 by tzara            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    try {
        sp.addNumber(4);
        std::cout << GREEN << "✓ SUCESS !" << RESET << std::endl; // ← reached = BAD
    }
    catch (std::exception& e) {
        std::cout << RED << "✗ Exception : " << e.what() << RESET << std::endl; // ← should be GREEN
}
    }
